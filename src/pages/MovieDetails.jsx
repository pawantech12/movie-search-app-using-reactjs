  ...
  return (
    <div className="p-8 min-h-screen bg-gray-900">
        ...
        <div className="flex justify-center gap-8">
          ...
          <div>
            ...
            <p className="flex gap-4 items-center">
              <span className="text-white border-2 border-white p-1 font-semibold">
                {movieDetails.Rated}
              </span>
              <span className="bg-white text-gray-900 border-2 border-white py-1 px-3 font-semibold">
                HD
              </span>
            ...
            <p className="flex items-center gap-4 text-gray-300">
              ...
              <span className="flex items-center gap-1">
                <IoTime className="text-yellow-400 text-xl" />
      ...
      {castDetails.length > 0 && (
        <div className="mt-8">
          <h2 className="text-3xl text-white mb-4">Cast</h2>
      ...
      {crewDetails.directors.length > 0 && (
        <div className="mt-8">
          <h2 className="text-3xl text-white mb-4">Director</h2>
          <div className="flex gap-4">
      ...
      {crewDetails.writers.length > 0 && (
        <div className="mt-8">
          <h2 className="text-3xl text-white mb-4">Writers</h2>
          <div className="flex gap-4">
